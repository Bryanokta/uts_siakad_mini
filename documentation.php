...
<body>
    ...
    <div class="hero-section text-center">
        <div class="container">
            ...
            <p class="hero-subtitle">Panduan Sistem Informasi Akademik dengan Pseudo-MVC & Aurora Design</p>
        </div>
    </div>
    ...
    <div class="doc-container mt-5 pb-5">
        ...
        <div class="card-doc">
            ...
            <p class="text-muted fw-medium mb-0">
                Mengusung antarmuka <strong>Aurora Enterprise Design</strong>, sistem ini memberikan pengalaman pengguna (UX) yang modern, bersih, efisien, dan responsif untuk berbagai ukuran layar.
            </p>
        </div>
        ...
        <div class="text-center text-muted fw-bold small mt-5">
            &copy; 2024 SIAKAD POLIJE - Developed with Aurora Design Concept.
        </div>
